...
def parse_meter(data):
    ...
    return {
        ...
        'kwh_total': parse_field(data[16:24]),
        'kwh_t1': parse_field(data[24:32]),
        'kwh_t2': parse_field(data[32:40]),
        'kwh_t3': parse_field(data[40:48]),
        'kwh_t4': parse_field(data[48:56]),
        'kwh_total_reverse': parse_field(data[56:64]),
        'kwh_t1_reverse': parse_field(data[64:72]),
        'kwh_t2_reverse': parse_field(data[72:80]),
        'kwh_t3_reverse': parse_field(data[80:88]),
        'kwh_t4_reverse': parse_field(data[88:96]),
        'volts_l1_l2': parse_field(data[96:100]),
        'volts_l2_l3': parse_field(data[100:104]),
        'volts_l3_l1': parse_field(data[104:108]),
        'amps_l1': parse_field(data[108:112]),
        'amps_l2': parse_field(data[112:116]),
        'amps_l3': parse_field(data[116:120]),
    }
